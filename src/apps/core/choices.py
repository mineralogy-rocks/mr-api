...
INHERIT_PHYSICAL_PROPERTIES = 3

INHERIT_CHOICES = (
    (INHERIT_FORMULA, "Inherit Formula"),
    (INHERIT_CRYSTAL_SYSTEM, "Inherit Crystal System"),
    (INHERIT_PHYSICAL_PROPERTIES, "Inherit Physical Properties"),
)


CONTEXT_PHYSICAL_PROPERTIES = 1
CONTEXT_OPTICAL_PROPERTIES = 2

CONTEXT_CHOICES = (
    (CONTEXT_PHYSICAL_PROPERTIES, "Physical Properties"),
    (CONTEXT_OPTICAL_PROPERTIES, "Optical Properties"),
)
